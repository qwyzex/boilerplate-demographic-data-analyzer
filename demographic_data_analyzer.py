...
def calculate_demographic_data(print_data=True):
    ...
    rich_min_workers = (df[df['hours-per-week'] == min_work_hours]['salary'] == '>50K').sum()
    ...
    highest_earning_country_percentage = round((country_counts / total_country_counts).max() * 100, 1)
